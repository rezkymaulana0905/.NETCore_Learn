...
class HomePagePortrait extends GetView<HomeController> {
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              const Expanded(child: LogActivity()),
            ],
          ),
          Container(
            alignment: Alignment.topCenter,
            margin: EdgeInsets.only(top: baseHeight * 0.275),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.only(
        top: baseHeight * 0.055,
        bottom: baseHeight * 0.025,
        left: baseWidth * 0.015,
        right: baseWidth * 0.015,
      ),
      child: Row(
        children: controller.menu.map((menu) => _buildMenu(menu)).toList(),
      ),
    );
  }
