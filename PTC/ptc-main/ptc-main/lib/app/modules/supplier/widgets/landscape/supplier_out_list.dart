        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: const Row(
              ...
              children: <Widget>[
                _MyTableColumn(label: "Date"),
                _MyTableColumn(label: "Vehicle ID"),
                _MyTableColumn(label: "Type"),
                _MyTableColumn(label: "Action"),
              ],
            ),
          ),
          Expanded(
...
class _MyTableColumn extends StatelessWidget {
  const _MyTableColumn({required this.label});
...
class _MyTableRow extends StatelessWidget {
  const _MyTableRow({
    required this.index,
