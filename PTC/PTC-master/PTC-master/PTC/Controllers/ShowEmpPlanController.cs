...
{
    public class ShowEmpPlanController(PtcContext context) : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchQuery, string startDate, string endDate, int? pageNumber)
        {
            ...
            var emp = db.TrxTmsEmpPcDtKpsFlt.AsQueryable(); 
            ...
            return View(await Pagination<TrxTmsEmpPcDtKpFlt>.CreateAsync(emp, pageNumber ?? 1, 10));
        }
    }
}
